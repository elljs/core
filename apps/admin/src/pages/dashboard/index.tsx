		...
		>
			<div className="space-y-4 pb-4">
				<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
						...
						<CardContent className="flex items-center justify-between">
							<div>
								<div className="text-2xl font-bold">
									$
									<NumberFlow className="ml-1" value={45231.89} />
								</div>
					...
					<Card>
						...
						<CardContent className="flex items-center justify-between">
							<div>
								<div className="text-2xl font-bold">
									+
									<NumberFlow className="ml-1" value={2350} />
								</div>
								<p className="text-xs text-muted-foreground text-emerald-500">
									+180.1% 较上个月
								</p>
					...
					<Card>
						...
						<CardContent className="flex items-center justify-between">
							<div>
								<div className="text-2xl font-bold">
									+
									<NumberFlow className="ml-1" value={12234} />
								</div>
					...
					<Card>
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
							<CardTitle className="text-sm font-medium">活跃中</CardTitle>
						...
						<CardContent className="flex items-center justify-between">
							<div>
								<div className="text-2xl font-bold">
									+
									<NumberFlow className="ml-1" value={573} />
								</div>
								<p className="text-xs text-muted-foreground text-emerald-500">
									+201 近一个小时以来
								</p>
				...
				<div className="grid grid-cols-1 gap-4 lg:grid-cols-7">
					<Card className="col-span-1 lg:col-span-3">
						<CardHeader>
							...
							<CardDescription>您这个月完成了265笔销售。</CardDescription>
						</CardHeader>
						<CardContent>
							<RecentSales />
						</CardContent>
