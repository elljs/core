...
import { Check, ChevronsUpDown, Copy, CornerDownLeft, Mic, Paperclip, RefreshCcw } from "lucide-react";
        ...
        <Page className="flex flex-col pb-4" header="聊天机器人">
            <Card className="flex flex-col flex-1 overflow-hidden">
                <CardHeader className="flex flex-row justify-center items-center space-x-2 space-y-0">
                    ...
                    <Popover open={state.modelOpen} onOpenChange={e => state.modelOpen = e}>
                                        ...
                                        {models.map((model) => (
                                            ...
                                            >
                                                <Check
                                                    className={cn(
                                                        "mr-2 h-4 w-4",
                                                        state.model === model.value ? "opacity-100" : "opacity-0"
                                                    )}
                                                />
                                                {model.label}
                                            </CommandItem>
